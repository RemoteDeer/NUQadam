    ...
    <div class="relative z-10 h-full">
      <div class="container mx-auto h-full px-6 flex flex-col justify-center">
        <div class="w-full md:w-3/5 lg:w-3/5">
          ...
          Sally Kz — Қазақстанның барлық өңіріндегі оқушыларға арналған онлайн білім беру орталығы. ҰБТ, SAT, IELTS емтихандарына және НИШ, КТЛ, РФМШ сынды үздік мектептерге дайындық — бәрі бір жерде. Назарбаев Университетінің үздік студенттері саған сапалы білімді қолжетімді бағамен жеткізеді.
          </p>
        </div>
